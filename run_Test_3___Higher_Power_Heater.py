...
Simple sanity check with higher power heater condition. Oil is finite, but at warm ambient condition of 85 C, so should be expected to heat over time.
"""
...
SNAPSHOT_FOLDER = "Test 3 - Higher Power Heater"
...
# --- Temperatures [K] ---
T_oil_setpoint = 358.15  # From backup log
T_ambient = 293.15  # From backup log
T_initial = 293.15

# --- Simulation Settings ---
Resolution = 140
Time_Total = 7200.0  # From backup log
