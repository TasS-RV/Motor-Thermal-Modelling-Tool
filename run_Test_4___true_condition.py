...
Actual conditions: 85 C ambient, 8 W heater, 170 C oil from just motor side. Most closely matches true condition. Assuming infinite oil thermal mass.
"""
...
SNAPSHOT_FOLDER = "Test 4 - true condition"
...
# --- Temperatures [K] ---
T_oil_setpoint = 443.15  # From backup log
T_ambient = 358.15  # From backup log
T_initial = 293.15

# --- Simulation Settings ---
Resolution = 140
Time_Total = 28800.0  # From backup log
